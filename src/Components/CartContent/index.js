    ...
    <section>
      ...
      <div className="data-info-container">
        <button
          ...
          onClick={handleAddFavouriteItemAndRouting}
        ></button>
        ...
        <div className="button-container">
          <button className="btn" onClick={handleAddOrCancelClick}>
            Add to cart
          </button>
        </div>
      </div>
      <article className={state ? "display-none-or-yep" : ""}>
        <div className="add-carting-window">
          ...
          <div className="action-buttons-style">
            ...
            <button onClick={handleAddOrCancelClick} className="button">
              Cancel
            </button>
          </div>
        </div>
